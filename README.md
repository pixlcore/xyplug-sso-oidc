...
- [Generate a State Secret](#generate-a-state-secret)
- [OIDC Configuration Reference](#oidc-configuration-reference)
	* [oidc.issuer](#oidcissuer)
	* [oidc.client_id](#oidcclient_id)
	* [oidc.client_secret](#oidcclient_secret)
	* [oidc.state_secret](#oidcstate_secret)
	* [oidc.scope](#oidcscope)
	* [oidc.token_endpoint_auth_method](#oidctoken_endpoint_auth_method)
	* [oidc.use_pkce](#oidcuse_pkce)
	* [oidc.claim_map](#oidcclaim_map)
	* [oidc.auth_params](#oidcauth_params)
	* [oidc.domain and endpoint overrides](#oidcdomain-and-endpoint-overrides)
	* [oidc.fetch_userinfo](#oidcfetch_userinfo)
	* [oidc.userinfo_method](#oidcuserinfo_method)
	* [oidc.require_id_token](#oidcrequire_id_token)
	* [oidc.request_timeout_ms](#oidcrequest_timeout_ms)
	* [oidc.clock_tolerance_seconds](#oidcclock_tolerance_seconds)
	* [oidc.signing_algorithms](#oidcsigning_algorithms)
- [Provider Setup](#provider-setup)
	* [Okta](#okta)
		+ [Okta Setup Tips](#okta-setup-tips)
		+ [Okta Authorization Server Access Policy](#okta-authorization-server-access-policy)
		+ [Okta Groups](#okta-groups)
		+ [Okta References](#okta-references)
		+ [Okta Example](#okta-example)
	* [Auth0](#auth0)
		+ [Auth0 References](#auth0-references)
		+ [Auth0 Example](#auth0-example)
	* [Microsoft Entra ID](#microsoft-entra-id)
		+ [Entra References](#entra-references)
		+ [Entra Example](#entra-example)
	* [Keycloak](#keycloak)
		+ [Keycloak Groups and Roles](#keycloak-groups-and-roles)
		+ [Keycloak References](#keycloak-references)
		+ [Keycloak Example](#keycloak-example)
	* [AWS Cognito Hosted UI](#aws-cognito-hosted-ui)
		+ [Cognito References](#cognito-references)
		+ [Cognito Issuer vs. Domain](#cognito-issuer-vs-domain)
		+ [Cognito Example](#cognito-example)
	* [SAML via SSOReady](#saml-via-ssoready)
		+ [SSOReady References](#ssoready-references)
		+ [SSOReady Example](#ssoready-example)
- [Header map recommendations](#header-map-recommendations)
- [Groups and roles](#groups-and-roles)
- [Security notes](#security-notes)
- [Logout](#logout)
- [Troubleshooting](#troubleshooting)
	* [Login redirects to the IdP but callback fails](#login-redirects-to-the-idp-but-callback-fails)
	* [Token validation fails](#token-validation-fails)
	* [User is missing email or username](#user-is-missing-email-or-username)
	* [Groups are missing](#groups-are-missing)
	* [Need more debugging output](#need-more-debugging-output)
